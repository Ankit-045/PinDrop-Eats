# ══════════════════════════════════════════════════════════════
#  ROLE 1 — Models + Schemas
#  Owner: Models & Database Schema Design
#  File: models.py — SQLAlchemy ORM Models
# ══════════════════════════════════════════════════════════════
...
class User(Base):
    ...
    phone = Column(String(20), nullable=True)  # NEW: phone number
...
class Dish(Base):
    ...
    category = Column(String(50), default="Main Course")  # NEW: Starter, Main Course, Dessert, Beverage
...
class AuditLog(Base):
    ...
    action = Column(String(100), nullable=False)  # e.g., "login", "order_placed", "status_changed"
    entity_type = Column(String(50), nullable=True)  # e.g., "order", "restaurant", "user"
